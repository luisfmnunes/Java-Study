...
public class ExemploComparatorList {
    ...
    public static void main(String[] args) {
        ...
        estudantes.sort((first,second) -> first.getIdade() - second.getIdade()); //função lambda
        ...
        System.out.println("--- ordem rever dos numeros - idade ---");
        System.out.println(estudantes);
        ...
        System.out.println("--- ordem rever dos números - idade (method reference) ---");
        System.out.println(estudantes);
        ...
        System.out.println("--- ordem rever dos números - idade (interface Comparator)");
        System.out.println(estudantes);
    }
}
